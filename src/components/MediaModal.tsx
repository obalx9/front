...
export default function MediaModal({
  ...
  const isAnimation = currentMedia.media_type === 'animation';
  const isVideoByExtension = !!(currentMedia.file_name && /\.(mp4|mov|avi|mkv|webm|m4v|3gp|flv|wmv)$/i.test(currentMedia.file_name));
  const isVideo = currentMedia.media_type === 'video' || isAnimation || isVideoByExtension;
