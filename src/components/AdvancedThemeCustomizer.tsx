        ...
        {activeSection === 'background' && (
          <div className="space-y-4">
            ...
            <GradientEditor
              ...
              onChange={(v) => updateConfig(['background', 'light'], v)}
            />

            <GradientEditor
              label={t('darkBackground')}
              value={config.background.dark}
              onChange={(v) => updateConfig(['background', 'dark'], v)}
            />
          </div>
        )}
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-4 pt-4 border-t border-gray-200 dark:border-gray-700">
              ...
              <GradientEditor
                ...
                onChange={(v) => updateConfig(['posts', 'light', 'bg'], v)}
              />
              <div>
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                  {t('opacity')}: {Math.round(config.posts.light.bgOpacity * 100)}%
                </label>
                <input
                  type="range"
                  min="0"
                  max="1"
                  step="0.05"
                  value={config.posts.light.bgOpacity}
                  onChange={(e) => updateConfig(['posts', 'light', 'bgOpacity'], parseFloat(e.target.value))}
                  className="w-full"
                />
              </div>
              <div>
            ...
            <div className="space-y-4 pt-4 border-t border-gray-200 dark:border-gray-700">
              ...
              <GradientEditor
                ...
                onChange={(v) => updateConfig(['posts', 'dark', 'bg'], v)}
              />
              <div>
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                  {t('opacity')}: {Math.round(config.posts.dark.bgOpacity * 100)}%
                </label>
                <input
                  type="range"
                  min="0"
                  max="1"
                  step="0.05"
                  value={config.posts.dark.bgOpacity}
                  onChange={(e) => updateConfig(['posts', 'dark', 'bgOpacity'], parseFloat(e.target.value))}
                  className="w-full"
                />
              </div>
              <div>
