    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-4xl mx-auto px-4 py-10">
        <article className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 md:p-12 prose prose-gray max-w-none">
          ...
          <section className="mb-8">
            <h2 className="text-lg font-semibold text-gray-800 mb-3">2. Состав обрабатываемых персональных данных</h2>
            <p className="text-gray-600 leading-relaxed mb-3">Оператор может обрабатывать следующие персональные данные:</p>
          ...
          <section className="mb-8">
            <h2 className="text-lg font-semibold text-gray-800 mb-3">3. Цели обработки персональных данных</h2>
            <ul className="list-disc pl-5 space-y-1 text-gray-600">
          ...
          <section className="mb-8">
            <h2 className="text-lg font-semibold text-gray-800 mb-3">4. Правовые основания обработки</h2>
            <p className="text-gray-600 leading-relaxed mb-3">Обработка персональных данных осуществляется на следующих основаниях:</p>
            <ul className="list-disc pl-5 space-y-1 text-gray-600">
          ...
          <section className="mb-8">
            <h2 className="text-lg font-semibold text-gray-800 mb-3">5. Передача персональных данных третьим лицам</h2>
            <p className="text-gray-600 leading-relaxed mb-3">
              Оператор не продаёт и не передаёт персональные данные третьим лицам в маркетинговых целях.
            </p>
            <p className="text-gray-600 leading-relaxed mb-3">Передача данных допускается в следующих случаях:</p>
            <ul className="list-disc pl-5 space-y-1 text-gray-600">
          ...
          <section className="mb-8">
            <h2 className="text-lg font-semibold text-gray-800 mb-3">6. Хранение и защита данных</h2>
            <p className="text-gray-600 leading-relaxed mb-3">
          ...
          <section className="mb-8">
            <h2 className="text-lg font-semibold text-gray-800 mb-3">7. Права субъекта персональных данных</h2>
            <p className="text-gray-600 leading-relaxed mb-3">Вы вправе:</p>
            <ul className="list-disc pl-5 space-y-1 text-gray-600">
          ...
          <section className="mb-8">
            <h2 className="text-lg font-semibold text-gray-800 mb-3">8. Использование cookie-файлов</h2>
            <p className="text-gray-600 leading-relaxed mb-3">
          ...
          <section className="mb-8">
            <h2 className="text-lg font-semibold text-gray-800 mb-3">9. Изменение Политики</h2>
            <p className="text-gray-600 leading-relaxed">
          ...
          <section>
            <h2 className="text-lg font-semibold text-gray-800 mb-3">10. Контакты оператора</h2>
