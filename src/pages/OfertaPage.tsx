    ...
    <div className="min-h-screen bg-gray-50">
      <header className="bg-white border-b border-gray-100 sticky top-0 z-10">
        <div className="max-w-4xl mx-auto px-4 py-3 flex items-center gap-3">
          ...
          <span className="font-bold text-teal-700">КейКурс</span>
        </div>
      </header>

      <main className="max-w-4xl mx-auto px-4 py-10">
        <article className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 md:p-12 prose prose-gray max-w-none">
          <h1 className="text-2xl font-bold text-gray-900 mb-2">Публичная оферта об оказании услуг</h1>
          <p className="text-sm text-gray-400 mb-8">Редакция от 20 апреля 2026 г.</p>

          <section className="mb-8">
            <h2 className="text-lg font-semibold text-gray-800 mb-3">1. Общие положения</h2>
            ...
            <p className="text-gray-600 leading-relaxed">
              Сайт: <span className="text-teal-600 font-medium">keykurs.ru</span>
            </p>
          </section>

          <section className="mb-8">
            <h2 className="text-lg font-semibold text-gray-800 mb-3">2. Термины и определения</h2>
            <ul className="space-y-2 text-gray-600 leading-relaxed list-none pl-0">
              <li><span className="font-medium text-gray-800">Платформа</span> — сайт keykurs.ru и связанные с ним сервисы.</li>
              <li><span className="font-medium text-gray-800">Пользователь (Покупатель)</span> — физическое лицо, акцептовавшее настоящую оферту.</li>
              <li><span className="font-medium text-gray-800">Курс</span> — цифровой образовательный продукт (набор текстовых, аудио-, видеоматериалов), размещённый на Платформе.</li>
              <li><span className="font-medium text-gray-800">Услуга</span> — предоставление Пользователю доступа к Курсу.</li>
            </ul>
          </section>

          <section className="mb-8">
            <h2 className="text-lg font-semibold text-gray-800 mb-3">3. Предмет договора</h2>
            <p className="text-gray-600 leading-relaxed mb-3">
          ...
          <section className="mb-8">
            <h2 className="text-lg font-semibold text-gray-800 mb-3">4. Цена и порядок оплаты</h2>
            <p className="text-gray-600 leading-relaxed mb-3">
          ...
          <section className="mb-8">
            <h2 className="text-lg font-semibold text-gray-800 mb-3">5. Права и обязанности сторон</h2>
          ...
          <section className="mb-8">
            <h2 className="text-lg font-semibold text-gray-800 mb-3">6. Возврат денежных средств</h2>
            <p className="text-gray-600 leading-relaxed mb-3">
          ...
          <section className="mb-8">
            <h2 className="text-lg font-semibold text-gray-800 mb-3">7. Ответственность сторон</h2>
            <p className="text-gray-600 leading-relaxed mb-3">
          ...
          <section className="mb-8">
            <h2 className="text-lg font-semibold text-gray-800 mb-3">8. Интеллектуальная собственность</h2>
            <p className="text-gray-600 leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="text-lg font-semibold text-gray-800 mb-3">9. Персональные данные</h2>
            <p className="text-gray-600 leading-relaxed">
              ...
              <a href="/privacy" className="text-teal-600 hover:underline">keykurs.ru/privacy</a>.
            </p>
          </section>

          <section className="mb-8">
            <h2 className="text-lg font-semibold text-gray-800 mb-3">10. Срок действия и изменение оферты</h2>
            <p className="text-gray-600 leading-relaxed mb-3">
          ...
          <section className="mb-8">
            <h2 className="text-lg font-semibold text-gray-800 mb-3">11. Разрешение споров</h2>
            <p className="text-gray-600 leading-relaxed">
          ...
          <section>
            <h2 className="text-lg font-semibold text-gray-800 mb-3">12. Реквизиты Исполнителя</h2>
            <div className="bg-gray-50 rounded-xl p-5 text-gray-600 space-y-1">
              <p><span className="font-medium text-gray-800">Наименование:</span> ИП Белов Сергей Андреевич</p>
              <p><span className="font-medium text-gray-800">ОГРНИП:</span> 324120000000011</p>
              <p><span className="font-medium text-gray-800">ИНН:</span> 121660921407</p>
              <p><span className="font-medium text-gray-800">Сайт:</span> keykurs.ru</p>
            </div>
          </section>
        </article>
      </main>
