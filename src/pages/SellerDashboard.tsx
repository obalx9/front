...
import { Store, Plus, Users, BookOpen, LogOut, CreditCard as Edit, Trash2, Eye, Send, MoreVertical, GraduationCap, FileText, X, BookMarked } from 'lucide-react';
...
export default function SellerDashboard() {
  ...
  const loadData = async () => {
    try {
      const sellerData = await api.getSellerProfile();
      setSeller(sellerData);

      if (sellerData) {
        const coursesData = await api.getSellerCourses();
